...
public class Repository {
    ...
    private static void branchDoubleHelper(String branchName, String newCommitId)
    {
        ...
        // 在head文件夹新增一个指向当前commit的branch文件
        String currentHash = newCommitId;


        // 写进HEADS_DIR里
        writeBranch(branchName, currentHash);
    }
    ...
    private static void printAffectedFiles()
    {
        ...
        for (String file : allExpectedFiles)
        {
            ...
            {
                // 场景：硬盘上有，但内容和记录的不一样
                String workFileHash = Utils.sha1(f);
    ...
    public static void mergeHelper(String branchName)
    {
        ...
        if (hasconflit == true) System.out.println("Encountered a merge conflict.");
    }
